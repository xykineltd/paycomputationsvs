...
public enum EmployeeGroupDeprecated {
    ...
    EmployeeGroupDeprecated(String aGroup, String aCode, String aDescription, String aCountry, String aPayScaleType, String aPayScaleArea){
        group = aGroup;
        code = aCode;
