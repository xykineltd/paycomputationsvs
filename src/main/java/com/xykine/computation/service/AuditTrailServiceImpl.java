...
public class AuditTrailServiceImpl implements AuditTrailService{
    ...
    public void logEvent(AuditTrailEvents eventType, String detail, String companyId) {
        AuthUtil.getCurrentUserDetails()
                .subscribe(user -> {
                    String employeeId = (String) user.getCustomAttribute("EmployeeID");
                    ...
                    // Save on boundedElastic so blocking I/O doesn’t freeze event loop
                    Mono.fromRunnable(() -> auditTrailRepo.save(auditTrail))
