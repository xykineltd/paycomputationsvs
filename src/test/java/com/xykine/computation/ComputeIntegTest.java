...
public class ComputeIntegTest extends AbstractIntegrationTest {
    ...
    protected static final Logger LOGGER = LoggerFactory.getLogger(ComputeIntegTest.class);

    @Test
    void testStartReportSummary() throws InterruptedException {
        when(adminService.getPaymentInfoList(any(), anyString())).thenReturn(TestDataFactory.getPaymentSettings("jackie chan"));
        Map<String, String> startJobResponse =  startReportSummary("2026-06-01", "2026-06-30", true);
        ...
        startJobResponse =  startReportSummary("2026-06-01", "2026-06-30", false);
        ...
        LOGGER.info("XXXXXXXXXXXXXX =>  {} ",  body.toString());
